const quotes = {
  ...
  inspired: [
    "«Երթա՛ առաջ, քամին միշտ փչում է խիզախ ճանապարհորդի թիկունքին»",
    "«Նպատակը լույս է, որ կուրացնում է կասկածներին»",
    "«Մեծ խորհուրդները սկսվում են փոքր քայլից, բայց հաստատակամ»"
  ],
  angry: [
    "«Զայրույթը կրակ է, որ առաջինը այրում է իր տան տիրոջը»",
    "«Մեկ խորը շունչը կարող է փրկել հազար ափսոսանք»",
    "«Բառերը, որ արտասանվում են զայրացած, դառնում են քար, իսկ լռությունը՝ մարած հուր»"
  ],
  calm: [
    "«Խաղաղ հոգին ջրի հայելի է, որում խառնված երկինքը պարզ է»",
